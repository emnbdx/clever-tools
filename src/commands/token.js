...
export async function create (params) {
  ...
  try {
    const response = await queryAuthBridge('POST', headers, AUTH_BRIDGE_ENDPOINT, body);
...
async function queryAuthBridge (method, headers, url = AUTH_BRIDGE_ENDPOINT, body = null) {
